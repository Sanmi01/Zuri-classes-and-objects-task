class Student:
    ...
    def change_name (self, new_name):
        old_name = self.name
        self.name = new_name
        print(f"Name was updated from {old_name} to {new_name}")
    ...
    def change_age (self, new_age):
        if type(new_age) != int:
            ...
            old_age = self.age
            self.age = new_age
            print(f"Age was updated from {old_age} to {new_age}")
    ...
    def change_score (self, new_score):
        if type(new_score) != int and type(new_score) != float:
            ...
            print(f"Score was updated from {old_score} to {new_score}")
